...
var hullPrices = [30,50,40,4]
var enginePrices = [10,20,50]
var thrusterPrices = [20,30,50,10]
var gunPrices = [10,15,40,40,25,35,20]

var coreTexts = ["CORE: Shield, Next hit no dmg","CORE: Teleport, Appear into new place","CORE: Damage+, Next shot 1.5x dmg","CORE: Clear, Destroys all enemy bullets"]
...
var engineTexts = ["ENGINE: Slow, 90% movement range","ENGINE: Medium, 100% movement range","ENGINE: Fast, 110% movement range"]
